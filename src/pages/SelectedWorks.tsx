...
const projects = [
  {
    id: "001",
    title: "TruthLens AI – Multimodal Fact Verification System",
    stack: "FastAPI / React 18 / TypeScript / Vite / Groq API",
    description: "Built a multimodal verification platform for text, image, and video using Agentic RAG and LLM reasoning via Groq API with deepfake detection. Integrated OpenCV, pytesseract, and librosa for visual, OCR, and audio analysis. Delivers deterministic TRUE/FALSE verdicts with confidence scores.",
    links: { live: "https://truth-lens-ai-two.vercel.app/", code: "https://github.com/Jrdheeraj/TruthLens-AI.git" },
    image: "/p1.png",
    cta: "View on Github"
  },
  {
    id: "002",
    title: "GeoAI – Urban Growth Monitoring System",
    stack: "Random Forest / NumPy / Rasterio / React / Leaflet / FastAPI",
    description: "Designed a geospatial analytics platform using Random Forest model on Google Earth Engine's Sentinel-2 imagery for pixel-level LULC change detection. Identified hotspots and risk zones across cities for real-time urban expansion monitoring and land-use intelligence.",
    links: { live: "https://geo-ai-urban-intelligence.vercel.app/", code: "https://github.com/Jrdheeraj/Geo-AI-urban-Intelligence.git" },
    image: "/p2.png",
    cta: "View on Github"
  },
  {
    id: "003",
    title: "Solar Scan AI",
    stack: "YOLOv8 / CNN / FastAPI / React / Docker / Google Static Maps API",
    description: "Developed a full-stack platform using YOLOv8 and CNN to detect solar panels from satellite imagery via Google Static Maps API. Calculates panel area, energy capacity, and financial ROI for rooftop solar potential analysis. Deployed with FastAPI, React, and Docker for scalable real-time analytics.",
    links: { live: "https://rooftop-solar-detection.vercel.app/", code: "https://github.com/Jrdheeraj/rooftop-solar-detection.git" },
    image: "/p3.png",
    cta: "View on Github"
  },
  {
    id: "004",
    title: "FactoryFix AI – Manufacturing Intelligence Platform",
    stack: "Random Forest / Pandas / NumPy / Scikit-learn / React",
    description: "Designed an AI system to predict machine failure risk, defect probability, and remaining useful life. Built a production-grade ML pipeline with comprehensive data preprocessing and feature engineering. Visualized machine health scores through a React web interface for predictive maintenance.",
    links: { live: "#", code: "https://github.com/Jrdheeraj/FactoryFIX.git" },
    image: "/p4.png",
    cta: "View on Github"
  },
  {
    id: "005",
    title: "OxyWalls – Smart Green Wall Air Purifier",
    stack: "Arduino / IoT / Air Quality Sensors / Relay Modules",
    description: "Led a team to develop an IoT prototype for automated real-time air purification using Arduino integrated with air quality sensors and relay modules. Demonstrated as Team Lead at the Atal Incubation Center Final Innovation Challenge and secured 2nd Best Innovation Award.",
    links: { live: "#", code: "#" },
    image: "/p5.jpg",
    cta: "View Project"
  },
...
const ScrollStackCard = ({ project, index }: ScrollStackCardProps) => {
  const isOxyWalls = project.id === "005";
    ...
    >
      <div className="card-top-row">
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          {!isOxyWalls && project.links.code && project.links.code !== "#" && (
            <StarBorder
              as="a"
          ...
          {!isOxyWalls && project.links.live && project.links.live !== "#" && (
            <StarBorder
              as="a"
