...
const navItems: NavItem[] = [
  ...
  { label: "Domains", href: "#philosophy", number: "02" },
  { label: "Selected Works", href: "#work", number: "03" },
  { label: "Achievements & Certifications", href: "#achievements", number: "04" },
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            animate="open"
            exit="closed"
            className="fixed inset-0 z-[100] bg-black flex flex-col justify-between px-8 md:px-16 pt-16 pb-10 md:pt-20 md:pb-14 overflow-y-auto"
          >
            {/* Socials row */}
            ...
            <nav className="flex flex-col gap-0">
              {navItems.map((item, i) => (
                <div
                  key={item.label}
                  className="overflow-hidden border-b border-white/25 py-2 md:py-3"
                >
                  <motion.a
                    href={item.href}
                  ...
                  >
                    <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-white uppercase tracking-tight leading-none whitespace-nowrap group-hover:translate-x-3 transition-transform duration-300 ease-out">
                      {item.label}
                    </span>
