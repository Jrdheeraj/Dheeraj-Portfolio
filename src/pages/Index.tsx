...
const SocialStrip = () => {
  const socials = [
    { label: "GitHub", href: "https://github.com/Jrdheeraj" },
    { label: "LINKEDIN", href: "https://www.linkedin.com/in/kannemadugu-dheeraj-479515289" },
    { label: "INSTAGRAM", href: "https://www.instagram.com/kdheerajj_/" },
    { label: "EMAIL", href: "mailto:jrdheeraj5@gmail.com" },
  ];
  return (
    <motion.div
...
const MobileSocialStrip = () => {
  const socials = [
    { label: "Github", icon: Github, href: "https://github.com/Jrdheeraj" },
    { label: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/in/kannemadugu-dheeraj-479515289" },
    { label: "Instagram", icon: Instagram, href: "https://www.instagram.com/kdheerajj_/" },
    { label: "Email", icon: Mail, href: "mailto:jrdheeraj5@gmail.com" },
  ];
  return (
    <motion.div
      initial={{ opacity: 0, x: 20 }}
  ...
  return (
    <div className="min-h-screen relative bg-black selection:bg-white selection:text-black">
      ...
      <section className="relative h-screen bg-black flex flex-col px-6 py-12 md:px-16 md:py-16 z-20 overflow-hidden">
        ...
        <div className="z-10 mt-auto mb-6 md:mb-8">
          ...
          >
            ...
            <h1 className="font-sans font-bold text-6xl md:text-7xl lg:text-[8rem] xl:text-[9rem] leading-[0.95] tracking-tighter text-white uppercase text-left">
              Scaling<br />AI Systems
            </h1>
          </motion.div>
        </div>
        ...
        <div className="z-10 grid grid-cols-1 md:grid-cols-12 w-full gap-4 mb-8 md:mb-0">
          ...
          >
            ...
            <p className="font-sans text-xs md:text-sm font-medium text-white leading-relaxed tracking-wide text-left">
              DEVELOPING SCALABLE AI SYSTEMS, AUTOMATING INTELLIGENT WORKFLOWS AND ENGINEERING ADAPTIVE DIGITAL SOLUTIONS.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="relative z-20 w-full bg-transparent">
        ...
        <div id="achievements" className="bg-black text-white relative z-20">
          <Testimonial />
        </div>
